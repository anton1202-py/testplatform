...
export const OrdersCartTab = ({ sortBy, platforms, setPlatformsToFilter, accountsToFilter, showCartTab, setShowCartTab, setOrdersItems, ordersType}) =>{
  ...
  const filterProducts = (platformIdx) => {
    ...
    analyticAPI.get(`order-items/?orders_type=${ordersType}&order__account__in=${accountsToFilter}&sort_by=${sortBy}&order__account__platform__platform_type__in=${platformsToFilter}`).then(
      response => {
